 ...
 *
 * KSM, KSK, dan MTK (Fase 4) SENGAJA tidak punya baris di
 * master_detail_transaksi — akun lawannya benar-benar bebas dipilih
 * pengguna saat itu juga, bukan ditentukan oleh template. Ketiganya
 * dijurnal lewat JurnalService::postingManual(), bukan posting().
 */
